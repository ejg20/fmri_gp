...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [mu_f, var_f] = gpgrid_predict_fullkron_denoise(xstar, hypvec, input, gpmodel, alpha, prodKs)
...
% tic
    ...
    mu_N = real(kron_mv(prodKs(1).Ks, alpha_to_N));
    mu_f = mu_N(xstar.index_to_N);
